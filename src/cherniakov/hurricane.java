...
public class hurricane implements Comparable<hurricane>{
    ...
    public hurricane() {} //JV nedelat prazdny konstruktor a settre pokud to neni potreba
    ...
    public int getSaffirSimpsonScale(){ //JV kdyz < 119, ostatni eles jen jedna podminka
