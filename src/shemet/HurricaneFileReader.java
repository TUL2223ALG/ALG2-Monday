...
public class HurricaneFileReader {
    ...
    public ArrayList<Hurricane> HFileReader(String path) {
        ...
        try {
            ...
            BufferedReader br = new BufferedReader(fr); //JV pouzit try with resources
            String line;
            ...
            e.printStackTrace();
            System.out.println("!Wrong path!"); //JV pokud bude chyba, jen vypise hlasku a bude pokracovat v aplikace jako by chyba nebyla
        }
        return arr;
    }
}
